...
export const Bike = {
  getStationByCityName: (cityName: keyof typeof stationCN, lat: number, lon: number) => GET(`${urlBikeStation}${cityName}?$spatialFilter=nearby(${lat},${lon},${1000})`, narrowingBikeStations),
